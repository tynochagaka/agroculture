			...
			<section id="one" class="wrapper style1 align-center">
				<div class="container">
					<form method="POST" action="uploadProduct.php" enctype="multipart/form-data">
						<h2>Share Your Knowledge About Agroforestry!!</h2>
						<br>
				<center>
					  ...
					  <div class="col-sm-6">
						  <div class="select-wrapper" style="width: auto" >
							  <select name="type" id="type" required style="background-color:white;color: black;">
								  ...
								  <option value="Service" style="color: black;">Agroforestry System Design</option>
								  <option value="Service" style="color: black;">Tree Species Selection</option>
								  <option value="Service" style="color: black;">Agroforestry Training and Education</option>
								  <option value="Service" style="color: black;">Site Assessment and Analysis</option>
								  <option value="Service" style="color: black;">Monitoring and Evaluation</option>
							  </select>
						</div>
					  </div>
					  <div class="col-sm-6">
						<input type="text" name="pname" id="pname" value="" placeholder="File Name" style="background-color:white;color: black;" />
					  </div>
				</div>
				<br>
				<div>
					<textarea  name="pinfo" id="pinfo" rows="12" placeholder="Information" style="background-color:white;color: black;"></textarea>
				</div>
			<br>
			<div class="row">
				<div class="col-sm-6">
					  <input type="text" name="price" id="price" value="" placeholder="Name" style="background-color:white;color: black;" />
				</div>
				<div class="col-sm-6">
