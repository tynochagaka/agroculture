...
<section id="one" class="wrapper style1 align-center">
    <div class="container">
        <header>
            <h2>AgroForestry</h2>
            <p>Let's Advance Agroforestry</p>
        </header>
        <div class="row 200%">
...
<footer class="footer-distributed" style="background-color:black" id="aboutUs">
    ...
    <div class="footer-left">
        <h3 style="font-family: 'Times New Roman', cursive;">AgroForestry&copy; </h3>
        <!--	<div class="logo">
    ...
    <div class="footer-center">
        <div>
            ...
            <p style="font-size:20px">AgroForestry Fam<span>Berekuso,Ghana</span></p>
        </div>
        <div>
        ...
        <div>
            ...
            <p style="font-size:20px"><a href="mailto:agroculture@gmail.com" style="color:white">tynochagaka@gmail.com</a></p>
        </div>
    </div>

    <div class="footer-right">
        <p class="footer-company-about" style="color:white">
            <span style="font-size:20px"><b>About AgroForestry</b></span>
            LEADING AGROFORESTRY INNOVATORS. SUSTAINABLE SOLUTIONS ADVOCATES
        </p>
