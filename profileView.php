    ...
    <body>
        ...
        <section id="one" class="wrapper style1 align">
            <div class="inner">
                ...
                <header>
                    <center>
                    <span><img src="<?php echo 'images/profileImages/'.$_SESSION['picName'].'?'.mt_rand(); ?>" class="image-circle" class="img-responsive" height="10%" width="40%"></span>
                    <br>
                            ...
                            <center>
                                <div class="row uniform">
                                    ...
                                    <div class="3u 12u$(xsmall)">
            							<a href="uploadProduct.php" class="btn btn-danger" style="text-decoration: none;">Share Resources</a>
            						</div>
                                    <div class="3u 12u$(large)">
