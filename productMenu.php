						...
						<center>
							...
							<div class="col-sm-2">
								<div class="select-wrapper" style="width: auto" >
								  ...
								  <option value="Agroforestry System Design" style="color: black;">Agroforestry System Design</option>
								  <option value="Tree Species Selection" style="color: black;">Tree Species Selection</option>
								  <option value="Agroforestry Training and Education" style="color: black;">Agroforestry Training and Education</option>
								  <option value="Site Assessment and Analysis" style="color: black;">Site Assessment and Analysis</option>
								  <option value="Monitoring and Evaluation" style="color: black;">Monitoring and Evaluation</option>
									</select>
							  	</div>
							</div>
							<div class="col-sm-2">
